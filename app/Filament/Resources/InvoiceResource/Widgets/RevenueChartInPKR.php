...
class RevenueChartInPKR extends ChartWidget
{
    protected static ?string $heading = 'Monthly Revenue in PKR';
    ...
    protected function getData(): array
    {
        ...
        foreach ($grouped as $month => $items) {
            ...
            $revenues->push($items->sum('amount_in_PKR')); // or 'paid_amount' if you have that field
        }
